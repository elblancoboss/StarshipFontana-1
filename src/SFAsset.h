 ...
 */
enum SFASSETTYPE {SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_ALIEN, SFASSET_COIN, SFASSET_ALIENMISSILE, SFASSET_STAR, SFASSET_HEALTHPACK, SFASSET_GAMEOVER, SFASSET_WALL};
